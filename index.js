...
'use strict';
var $, EventEmitter, React, ReactDom, ReactDomServer, bind, createRootOptions, createSubOptions, rootComponent, subComponent;
...
rootComponent = {
  ...
  componentWillMount: function() {
    ...
    for (key in events) {
      val = events[key];
      results.push(this._pubsub.on(key, bind(val, this)));
    }
    return results;
  },
...
subComponent = {
  ...
  componentDidMount: function() {
    ...
    for (key in events) {
      ...
      if (delegate) {
        results.push($rootDOM.on(type, delegate, bind(val, this)));
      } else {
        results.push($rootDOM.on(type, bind(val, this)));
      }
    }
    return results;
  },
